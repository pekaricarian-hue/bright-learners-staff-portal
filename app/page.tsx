...
const abLessonSlides: OrientationSlide[][] = [
  ...
  [
    { kicker: "Positive guidance", title: "Teach the behaviour children need", body: "Use calm redirection, clear expectations, choices and environments that support success. Never shame, threaten or use physical punishment.", ref: "Bright Learners Orientation, May 2026 - slides 51-54; Bright Learners Academy Final Staff Handbook, May 2026 - pages 30 and 33-34 (shared policy); Alberta Child Care Licensing Handbook - child guidance" },
...
const skLessonSlides: OrientationSlide[][] = [
  ...
  [
    ...
    { kicker: "When to wash", title: "Handwashing follows every contamination risk", body: "Staff wash with soap and warm running water before and after eating, handling food, feeding children, administering medication, diapering or toileting, and after wiping noses, coughing, sneezing, contact with bodily fluids or whenever hands are visibly soiled.", points: ["Wet hands and apply soap", "Rub every surface thoroughly", "Rinse under running water", "Dry with a single-use towel"], ref: "Bright Learners Academy Final Staff Handbook, May 2026 - page 36 (shared policy); Saskatchewan public-health hand-hygiene guidance" },
  ...
  [
    ...
    { kicker: "Receive a disclosure", title: "Listen without investigating", body: "Stay calm, allow the child to use their own words, ask only minimal non-leading questions needed for immediate safety and do not promise secrecy. Record the child's exact words and relevant context as soon as possible.", scenario: { situation: "A child says someone hurt them and asks the educator not to tell.", prompt: "What should the educator say and do?", response: "Acknowledge the child, explain that you must get help to keep them safe, avoid leading questions, record their words and make the required report immediately." }, ref: "The Child and Family Services Act (Saskatchewan); Bright Learners Academy Final Staff Handbook - child-safety and reporting policies" },
