...
const abLessonSlides: OrientationSlide[][] = [
  [
    ...
    { kicker: "Families", title: "Build trust every day", body: "Greet families by name, listen carefully, repeat important care instructions and share useful updates. Keep personal information private.", media: "Family greeting scenario", image: { src: "/course-media/ai-family-arrival-communication.png", alt: "Educator welcoming a family and confirming care information at arrival", credit: "Original Bright Learners training illustration" }, ref: "Bright Learners Orientation, May 2026 - slides 11-12, 36-39" },
    ...
    { kicker: "First day", title: "Help each child and family feel welcome", body: "Prepare the room, greet the family, confirm allergies and care instructions, support separation calmly and provide a positive pickup update.", media: "First-day welcome illustration", image: { src: "/course-media/ai-first-day-welcome.png", alt: "Educator welcoming a child on their first day while confirming care items with a parent", credit: "Original Bright Learners training illustration" }, ref: "Bright Learners Orientation, May 2026 - slides 56-58" },
    { kicker: "Leadership", title: "Know who to ask at your academy", body: "Your director coordinates daily operations, staffing, safety questions, family concerns and licensing follow-up. Raise urgent issues immediately instead of waiting for a meeting or the end of your shift.", points: ["Sundance - Margaret Ferriss", "Midnapore - Karla Buick", "Sylvan Lake - Sherry Murphy", "Millwoods - Evelyn Mahmoudi"], media: "Director introductions and academy photos", image: { src: "/course-media/ai-director-leadership.png", alt: "A diverse Bright Learners leadership team meeting together", credit: "Original Bright Learners training illustration" }, ref: "Bright Learners Orientation, May 2026 - slide 5; Bright Learners location directory" },
    ...
    { kicker: "Chain of communication", title: "Say what happened, not what you assume", body: "When reporting a concern, give the director clear facts: who was involved, what you observed, where and when it happened, what immediate action you took and what still needs attention.", media: "Fact-based handover scenario", image: { src: "/course-media/ai-factual-handover.png", alt: "Educator giving a factual, time-specific handover to a director", credit: "Original Bright Learners training illustration" }, ref: "Bright Learners Orientation, May 2026 - communication expectations, slides 11-15 and 36-39" },
    ...
    { kicker: "Digital communication", title: "Use Lillio and photographs with purpose", body: "Use approved accounts and centre devices according to Bright Learners policy. Posts and photographs should support meaningful family communication while protecting every child's dignity, consent requirements and personal information.", media: "Approved versus inappropriate documentation examples", image: { src: "/course-media/ai-approved-photo-documentation.png", alt: "Educator using an approved centre tablet for purposeful classroom documentation", credit: "Original Bright Learners training illustration" }, ref: "Bright Learners Orientation, May 2026 - documentation and Lillio content, slides 34-39" },
  ...
  [
    ...
    { kicker: "Document", title: "Make learning visible", body: "Documentation explains the learning, not just the activity. Use accurate notes and purposeful photos while protecting dignity and privacy.", media: "Learning-story and Lillio examples", image: { src: "/course-media/ai-learning-story.png", alt: "Educator creating an objective learning story from notes and approved classroom photos", credit: "Original Bright Learners training illustration" }, ref: "Bright Learners Orientation, May 2026 - slides 34-39" },
  ...
  [
    ...
    { kicker: "Transitions", title: "Count children every time the group moves", body: "Complete and verbally confirm headcounts when leaving or entering rooms, playgrounds and vehicles. Compare the count with attendance.", media: "Headcount demonstration", image: { src: "/course-media/ai-headcount-transition.png", alt: "Educators confirming attendance during a supervised group transition", credit: "Original Bright Learners training illustration" }, ref: "Bright Learners Orientation, May 2026 - slides 40-43" },
    ...
    { kicker: "Playspaces", title: "Inspect before children play", body: "Check equipment, surfacing, gates, debris, entrapment risks and weather conditions. Block unsafe equipment and report it immediately.", media: "Outdoor inspection walkthrough", image: { src: "/course-media/ai-playground-precheck.png", alt: "Educator checking a playground gate, surfacing and equipment before children enter", credit: "Original Bright Learners training illustration" }, ref: "AHS Inspection and Maintenance of Playspaces - inspection and maintenance sections" },
  ...
  [
    ...
    { kicker: "Respond", title: "Separate, supervise and contact the family", body: "Move the sick child away from the group while keeping them comfortable and supervised. Contact the parent or guardian for prompt pickup.", media: "Illness response scenario", image: { src: "/course-media/ai-family-illness-contact.png", alt: "Educator supervising an unwell child while contacting the family as another educator supervises the group", credit: "Original Bright Learners training illustration" }, ref: "AHS Health & Safety Guidelines for Child Care Facilities - illness management" },
  ...
  [
    ...
    { kicker: "Correct order", title: "Always clean before sanitizing or disinfecting", body: "Remove debris, wash with detergent, rinse when required, then apply the approved sanitizer or disinfectant.", media: "Four-step cleaning demonstration", image: { src: "/course-media/ai-four-step-cleaning.png", alt: "Educator completing the four-step cleaning and sanitizing process in order", credit: "Original Bright Learners training illustration" }, ref: "AHS Cleaning and Sanitizing Food Contact Surfaces, Equipment, Toys and Other Surfaces" },
    ...
    { kicker: "Toy schedule", title: "Mouthed toys are removed immediately", body: "Place mouthed toys in the designated dirty-toy container and clean and sanitize them before another child uses them. Follow the posted schedule for all other toys.", media: "Mouthed-toy procedure photos", image: { src: "/course-media/ai-mouthed-toy-bin.png", alt: "Educator placing a mouthed toy into the dirty-toy container before another child can use it", credit: "Original Bright Learners training illustration" }, ref: "AHS Health & Safety Guidelines for Child Care Facilities - toy cleaning; Appendix cleaning schedules" },
    ...
    { kicker: "Outbreak response", title: "Increase cleaning when gastrointestinal illness spreads", body: "During a suspected or confirmed gastrointestinal outbreak, follow the director's and AHS directions for enhanced frequency, higher-risk touch points, product selection and documentation. Routine cleaning alone may not be enough.", media: "GI outbreak enhanced-cleaning walkthrough", image: { src: "/course-media/ai-gi-outbreak-cleaning.png", alt: "Educator completing enhanced cleaning of high-touch surfaces during an illness outbreak", credit: "Original Bright Learners training illustration" }, ref: "Alberta Health Services, Surface Cleaning/Disinfection Guidelines for GI Outbreaks in Child Care Facilities, PUB-0734-201501" },
  ...
  [
    ...
    { kicker: "Temperatures", title: "Keep cold food cold and hot food hot", body: "Use a clean, sanitized thermometer and follow the centre's approved temperature limits, monitoring and corrective-action procedure.", media: "Food temperature demonstration", image: { src: "/course-media/ai-food-temperature.png", alt: "Educator using a sanitized thermometer to check food temperature before service", credit: "Original Bright Learners training illustration" }, ref: "AHS Health & Safety Guidelines for Child Care Facilities - food temperature control" },
  ...
  [
    ...
    { kicker: "Sleep", title: "Use a safe crib and complete checks", body: "Inspect the crib, use approved sleep equipment and follow the child's plan and required supervision. Remove damaged equipment from use.", media: "Crib safety inspection", image: { src: "/course-media/ai-crib-safety-check.png", alt: "Educator completing a safety inspection of an empty approved crib", credit: "Original Bright Learners training illustration" }, ref: "AHS Crib Safety Checklist" },
  ...
  [
    ...
    { kicker: "Incident response", title: "Care first, then document", body: "Provide appropriate first aid, notify the director and family, preserve factual details and complete the required report promptly.", media: "Incident documentation example", image: { src: "/course-media/ai-incident-report.png", alt: "Educator completing a factual incident report promptly with the director", credit: "Original Bright Learners training illustration" }, ref: "Bright Learners Orientation, May 2026 - incident reporting; Alberta Child Care Licensing Handbook" },
    ...
    { kicker: "During an emergency", title: "Maintain supervision and account for everyone", body: "Follow the centre plan, bring attendance information, count children throughout and do not re-enter until authorized.", media: "Evacuation drill illustration", image: { src: "/course-media/ai-emergency-headcount.png", alt: "Educators maintaining supervision and confirming attendance during an evacuation drill", credit: "Original Bright Learners training illustration" }, ref: "Bright Learners Orientation, May 2026 - emergency procedures; Alberta licensing requirements" },
...
const skLessonSlides: OrientationSlide[][] = [
  [
    ...
    { kicker: "How we learn", title: "Saskatchewan uses Play and Exploration", body: "The Saskatchewan framework supports curiosity, relationships, belonging and learning through play. Bright Learners combines it with emergent curriculum and Reggio Emilia practices.", points: ["Observe children before planning", "Build from their questions and interests", "Make learning visible to families"], media: "Child-led classroom exploration", image: { src: "/course-media/ai-sk-child-led-exploration.png", alt: "Children independently exploring light, colour and natural materials while an educator observes", credit: "Original Bright Learners training illustration" }, ref: "Willowgrove Parent Handbook - pages 9-11; Bright Learners Orientation, May 2026 - slide 24" },
    ...
    { kicker: "Observe and plan", title: "Turn children's interests into learning", body: "Observe what children repeatedly investigate, say and attempt. Use those observations to plan open-ended experiences, questions and materials that extend thinking while remaining safe and suitable for the group.", media: "Balance and movement provocation", image: { src: "/course-media/ai-sk-balance-movement.png", alt: "Children testing balance and movement with safe outdoor loose parts while an educator extends their thinking", credit: "Original Bright Learners training illustration" }, scenario: { situation: "Several children spend the morning moving stones, leaves and water between containers outside.", prompt: "How could the educator extend this interest?", response: "Document what the children are testing, then offer safe containers, measuring tools and questions about volume, texture or change. Check every loose material for age, ingestion and sanitation risk before use." }, ref: "Willowgrove Parent Handbook - Play and Exploration, pages 9-11; Bright Learners Orientation, May 2026 - slides 16-33" },
    { kicker: "Document learning", title: "Record the learning, not just the activity", body: "A useful observation includes what the child did or said, the context, the learning you noticed and a possible next step. Photographs should be purposeful, respectful and taken only through approved centre practices.", points: ["Use objective language", "Avoid labels or diagnoses", "Connect observations to future planning", "Protect children who should not appear in a photograph"], media: "Documented classroom provocation", image: { src: "/course-media/ai-sk-learning-documentation.png", alt: "Educator documenting a collaborative child-built neighbourhood with objective notes and an approved photo", credit: "Original Bright Learners training illustration" }, ref: "Bright Learners Orientation, May 2026 - observation, documentation and Lillio content, slides 24-39; Willowgrove Parent Handbook - programming sections" },
